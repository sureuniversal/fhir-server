...
public class ObservationRules extends RuleBase {
  ...
  public List<IAuthRule> HandleGet() {
    ...
    var patientRule = new RuleBuilder().allow().read().resourcesOfType("Observation").inCompartment("Patient", this.userIds).build();
  ...
  public List<IAuthRule> HandlePost() {
    var ruleList = new ArrayList<IAuthRule>();
    var patientRule = new RuleBuilder().allow().write().resourcesOfType("Observation").inCompartment("Patient", this.userIds).build();
